...
NAN_METHOD(hwrTestParamInOut) {
		v8::Local<v8::String> strHandle = info[0].As<v8::String>();
		v8::Local<v8::Function> callbackHandle = info[1].As<v8::Function>();
		Nan::AsyncResource* resource = new Nan::AsyncResource(Nan::New<v8::String>("MyObject:hwrTestParamInOut").ToLocalChecked());
		int argc = 1;
		v8::Local<v8::Value> argv[] = {
				Nan::New("parameter test").ToLocalChecked()
		};
