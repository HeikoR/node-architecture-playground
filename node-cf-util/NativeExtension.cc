...
NAN_MODULE_INIT(InitAll) {
	...
	Nan::Set(target, Nan::New("hwrTestParamInOut").ToLocalChecked(),
		Nan::GetFunction(Nan::New<FunctionTemplate>(hwrTestParamInOut)).ToLocalChecked());

	// Nan::Set(target, Nan::New("encryptCC").ToLocalChecked(),
		// Nan::GetFunction(Nan::New<FunctionTemplate>(encryptCC)).ToLocalChecked());
	// Nan::Set(target, Nan::New("decryptCC").ToLocalChecked(),
		// Nan::GetFunction(Nan::New<FunctionTemplate>(decryptCC)).ToLocalChecked());
